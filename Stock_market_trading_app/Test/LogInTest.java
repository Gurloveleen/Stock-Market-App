...
public class LogInTest {
    ...
    public void setUp() throws IOException, JSONException {
        ...
        String sampleUserData = "{ \"1001\": { \"userName\": \"john_doe\", \"password\": \"password123\", \"balance\": \"5000\" } }";
    ...
    public void testSignIn() throws JSONException {
        Account validAccount = new Account("1001", "john_doe", "password123", 5000);
        assertTrue(logIn.signIn(validAccount));

        Account invalidAccount = new Account("1001", "john_doe", "wrong_password", 5000);
        assertFalse(logIn.signIn(invalidAccount));
    }

    @Test
    public void testSignUp() throws JSONException, FileNotFoundException {
        Account newAccount = new Account("1002", "jane_doe", "jane_password", 4000);
